...
export const adminCopy = {
  ...
  repairActivities: {
    label: "Activities",
    title: "维修活动",
    lead: "创建与管理面向公众的维修活动：设定时间窗口与名额，公开端按派生状态报名。",
    table: {
      title: "标题",
      activityAt: "活动时间",
      window: "报名窗口",
    ...
    create: {
      title: "新建活动",
      titleField: "标题",
      capacity: "人数上限（至少 1 人）",
      activityAt: "活动时间",
      signupOpensAt: "报名开始",
      signupClosesAt: "报名截止",
      timeHint: "报名开始须早于截止，截止不得晚于活动开始。时间按你的本地时区填写。",
      submit: "创建活动",
      created: "活动已创建。",
    },
    edit: {
    ...
    action: { edit: "编辑", remove: "删除", registrations: "报名管理" },
    registrations: {
      title: "报名管理",
      count: "共 {count} 条报名",
      name: "姓名",
  ...
  audit: {
    ...
    targetLabels: {
      ...
      Skill: "技能标签",
      RepairActivity: "维修活动",
      RepairActivityRegistration: "活动报名",
      InviteCode: "邀请码",
